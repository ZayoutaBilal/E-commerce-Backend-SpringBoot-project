...
public class Success {
    ...
    public static String UPDATE_DISCOUNT = "message.response.success.update-discount";
    public static String DELETE_DISCOUNT = "message.response.success.delete-discount";
    public static String ADD_DISCOUNT = "message.response.success.add-discount";
